...
User.create!(first_name: 'Kathy', last_name: 'Rhoden', email: 'kathy13@gmail.com', password: '123456', role: 'advisor', response_time: '15', bill_paying: true, bio: 'Hello my name is Kathy!')
