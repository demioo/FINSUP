...
User.create!(first_name: 'Marc', last_name: 'Levy', email: 'marc@gmail.coms', password: '123456', role: 'advisor', response_time: '15', saving: true)
...
User.create!(first_name: 'Melissa', last_name: 'Brett', email: 'mexl@gmail.com', password: '123456', role: 'advisor', response_time: '10', budgeting: true)
